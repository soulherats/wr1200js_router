...
#include "common.h"
	...
	struct variable variables_IP6Connection[] = {
			...
			{"ip6_lan_relay", "", NULL, EVM_RESTART_NDPPD},
#endif
			{0,0,0,0}
		};
	...
	struct variable variables_LANHostConfig[] = {
			...
			{"ipsec_psk", "", NULL, EVM_REAPPLY_VPNSVR},
			{"vpns_cast", "", NULL, FALSE},
			{"vpns_auth", "", NULL, EVM_REAPPLY_VPNSVR},
			{"strswan.ipsec.conf", "File", NULL, EVM_REAPPLY_VPNSVR},
	...
	struct variable variables_WLANConfig11a[] = {
			...
			{"wl_sta_pmf", "", NULL, EVM_RESTART_WIFI5},
	...
	struct variable variables_ShadowsocksConf[] = {
			...
			{"ss_simple_obfs","",NULL, EVM_RESTART_SHADOWSOCKS|EVM_RESTART_SS_TUNNEL},
	...
	struct evDesc events_desc[] = {
		{EVM_RESTART_IPV6,		EVT_RESTART_IPV6,		RCN_RESTART_IPV6,	EVM_RESTART_DHCPD|EVM_RESTART_RADV|EVM_RESTART_IPTV|EVM_RESTART_DI|EVM_RESTART_UPNP|EVM_RESTART_FIREWALL|EVM_RESTART_VPNCLI|EVM_RESTART_SWITCH_VLAN|EVM_RESTART_LAN|EVM_RESTART_WAN|EVM_RESTART_MODEM|EVM_RESTART_NDPPD},
...
#endif
		{EVM_RESTART_WAN,		EVT_RESTART_WAN,		RCN_RESTART_WAN,	EVM_RESTART_IPTV|EVM_RESTART_SWITCH_VLAN|EVM_RESTART_FIREWALL|EVM_RESTART_VPNCLI|EVM_RESTART_NETFILTER|EVM_RESTART_DDNSTO},
...
#endif
		{EVM_RESTART_NDPPD,		EVT_RESTART_NDPPD,		RCN_RESTART_NDPPD,  0},
