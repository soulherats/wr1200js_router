                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_lwf_main" style="display:none">
                                        <tr>
                                            <th colspan="2" style="background-color: rgba(171, 168, 167,0.2);"><#menu5_5_4#></th>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table table-list" id="LWFilterList_Block" style="display:none">
                                        <tr>
                                            <th colspan="6" style="background-color: rgba(171, 168, 167,0.2);"><#FirewallConfig_LWFilterList_groupitemdesc#></th>
                                        </tr>
                                        <tr>
