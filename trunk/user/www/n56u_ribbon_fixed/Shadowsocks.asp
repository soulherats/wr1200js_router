...
function isValidHttpUrl(str) {
	return !!str.match(/^(https?:\/\/)([0-9a-z.]+)(:[0-9]+)?([/0-9a-z.]+)?(\?[0-9a-z&=]+)?(#[0-9-a-z]+)?/i);
}

function applyRule(){
	var o = document.form.ss_link;
	if (isValidHttpUrl(o.value)) {
        	parent.showLoading();
            ...
            <div class="span9">
                ...
                <div class="row-fluid">
					...
					<tr> <th width="50%"><#menu5_16_12#></th>
                                        ...
                                        <tr> <th colspan="2" style="background-color: rgba(171, 168, 167,0.2);"><#menu5_16_3#></th> </tr>
                                        ...
                                        <tr> <th colspan="2" style="background-color: rgba(171, 168, 167,0.2);"><#menu5_16_8#></th> </tr>
                                        ...
                                        <tr> <th colspan="2" style="background-color: rgba(171, 168, 167,0.2);"><#ChnRoute#></th> </tr>
                                        ...
                                        <tr> <th colspan="2" style="background-color: rgba(171, 168, 167,0.2);"><#GfwList#></th> </tr>
...
<form method="post" name="Shadowsocks_action" action="" onsubmit="loginSubmit()"  target="hidden_frame">
