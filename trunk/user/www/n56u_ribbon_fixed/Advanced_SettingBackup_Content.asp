                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th colspan="2" style="background-color: rgba(171, 168, 167,0.2);"><#Adm_Setting_nvram#></th>
                                        </tr>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_rwfs" style="display:none">
                                        <tr>
                                            <th colspan="2" style="background-color: rgba(171, 168, 167,0.2);"><#Adm_Setting_rwfs#></th>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th colspan="3" style="background-color: rgba(171, 168, 167,0.2);"><#Adm_Setting_store#></th>
                                        </tr>
